...
ou might review the [bind vignette](https://dplyr.tidyverse.org/reference/bind.html) in the Tidyverse documentation.
...
ou might review the [join vignette](https://dplyr.tidyverse.org/reference/mutate-joins.html) in the Tidyverse documentation.
