...
Your first task: apply beginning [tidyverse](https://www.tidyverse.org/) skills to learn about the characters in the Star Wars universe you'll be reporting on.

Throughout this trial we will use the data collection called `starwars`, which is included with the `dplyr` package within the [tidyverse](https://www.tidyverse.org/). Let's learn a bit more about the structure of the `starwars` data and how to conquer these JedR Trials.
