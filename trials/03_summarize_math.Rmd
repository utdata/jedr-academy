---
title: "JedR Trail 3: Summarizing by Math"
output: 
  learnr::tutorial:
    progressive: true
...
## JedR Trail 3: Summarize with math

Welcome, Padawan. In this exercise, you'll be tested on skills using math-based `summarize()` functions. This is covered in Reporting with Data in R [Chapter 5](https://utdata.github.io/rwdir/sums-analyze.html#item-quantities-totals-for-local-agencies).  Like our previous exercise, we'll be using the dataset `starwars` in the `tidyverse` packages.
