...
- [Categorization](https://utdata.shinyapps.io/jedr-categorization/): When you need to re-categorize your data.
...
- Using `across()`. Maybe [this can help](https://github.com/utdata/r-across-examples)
...
With exception of characters, the above is from [Kaggle](https://www.kaggle.com/jsphyg/star-wars), which was gathered using the Star Wars API that is no longer available. The origin of the data is The Star Wars Wiki: https://starwars.fandom.com/wiki.
