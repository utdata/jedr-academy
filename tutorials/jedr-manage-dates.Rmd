...
rebels_cl <- read_csv("https://github.com/utdata/jedr-academy/blob/date-tutorial/data/starwarsrebels.csv?raw=true") |> 
  clean_names() |> 
  mutate(air_date_fixed = dmy(original_air_date)) |> 
  select(-original_air_date)

rebels_cl_newcols <- read_csv("https://github.com/utdata/jedr-academy/blob/date-tutorial/data/starwarsrebels.csv?raw=true") |> 
  clean_names() |> 
  mutate(air_date_fixed = dmy(original_air_date)) |> 
...
```{r import, message=F}
rebels_raw <- read_csv("https://github.com/utdata/jedr-academy/blob/date-tutorial/data/starwarsrebels.csv?raw=true") # import data
