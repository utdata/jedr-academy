...
that_correct <- c('That is correct!')
...
This shows the first-aired episode for each of the years from 2014–2018. Notice the few doppelgängers? It looks liek seasons 3 and 4 started each started with a double episode.
